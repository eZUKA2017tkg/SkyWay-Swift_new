...
class MenuViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnVideoChat.setTitle("おかあさん"/*"Media connection"*/, for: UIControlState.normal)
        ...
        btnChat.setTitle("おとうさん"/*"Data connection"*/, for: UIControlState.normal)
    ...
    @objc func touchUpInside(_ sender: Any) {
        if let btn: UIButton = sender as? UIButton {
            ...
            if ViewTag.BTN_VIDEOCHAT.rawValue == btn.tag {
                ...
                let strTitle: String = "おかあさん"/*"Media connection"*/
